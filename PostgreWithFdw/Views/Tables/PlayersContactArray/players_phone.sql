...
WHERE players_contact_a4_0.EMAIL = 'Null' AND players_contact_a4_0.PHONE  <>  'Null' ) AS players_phone_a3_0  ) AS __dummy__;
...
WHERE p_1_a3_0.COL2 = 'Null' ) AS p_0_a0_0  ) AS bot_a0_0  ) AS __dummy__ )
        THEN 
...
FROM public.players_contact AS players_contact_a4_0 
WHERE players_contact_a4_0.EMAIL  <>  'Null' AND players_contact_a4_0.PHONE  <>  'Null'  UNION ALL SELECT  
FROM public.players_contact AS players_contact_a4_0 
WHERE players_contact_a4_0.EMAIL = 'Null' AND players_contact_a4_0.PHONE = 'Null' ) AS p_0_a0_0  ) AS bot_a0_0  ) AS __dummy__ )
        THEN 
