...
SELECT __dummy__.COL0 AS ORIGINAL_ID,__dummy__.COL1 AS ITEM,__dummy__.COL2 AS QTY,__dummy__.COL3 AS UOM 
FROM (SELECT item_a4_0.COL0 AS COL0, item_a4_0.COL1 AS COL1, item_a4_0.COL2 AS COL2, item_a4_0.COL3 AS COL3 
FROM (SELECT gorda_a7_0.ORIGINAL_ID AS COL0, gorda_a7_0.ITEM AS COL1, gorda_a7_0.QTY AS COL2, gorda_a7_0.UOM AS COL3 
FROM public.gorda AS gorda_a7_0  ) AS item_a4_0  ) AS __dummy__;
...
FROM (SELECT  
FROM (SELECT  
FROM (SELECT __tmp_delta_ins_item_a4_0.UOM AS COL0, __tmp_delta_ins_item_a4_0.QTY AS COL1, __tmp_delta_ins_item_a4_0.ITEM AS COL2, __tmp_delta_ins_item_a4_0.ORIGINAL_ID AS COL3 
FROM __tmp_delta_ins_item AS __tmp_delta_ins_item_a4_0   UNION SELECT item_a4_0.UOM AS COL0, item_a4_0.QTY AS COL1, item_a4_0.ITEM AS COL2, item_a4_0.ORIGINAL_ID AS COL3 
FROM public.item AS item_a4_0 
WHERE NOT EXISTS ( SELECT * 
FROM __tmp_delta_del_item AS __tmp_delta_del_item_a4 
WHERE __tmp_delta_del_item_a4.UOM = item_a4_0.UOM AND __tmp_delta_del_item_a4.QTY = item_a4_0.QTY AND __tmp_delta_del_item_a4.ITEM = item_a4_0.ITEM AND __tmp_delta_del_item_a4.ORIGINAL_ID = item_a4_0.ORIGINAL_ID ) ) AS p_2_a4_0, (SELECT __tmp_delta_ins_item_a4_0.UOM AS COL0, __tmp_delta_ins_item_a4_0.QTY AS COL1, __tmp_delta_ins_item_a4_0.ITEM AS COL2, __tmp_delta_ins_item_a4_0.ORIGINAL_ID AS COL3 
FROM __tmp_delta_ins_item AS __tmp_delta_ins_item_a4_0   UNION SELECT item_a4_0.UOM AS COL0, item_a4_0.QTY AS COL1, item_a4_0.ITEM AS COL2, item_a4_0.ORIGINAL_ID AS COL3 
FROM public.item AS item_a4_0 
WHERE NOT EXISTS ( SELECT * 
FROM __tmp_delta_del_item AS __tmp_delta_del_item_a4 
WHERE __tmp_delta_del_item_a4.UOM = item_a4_0.UOM AND __tmp_delta_del_item_a4.QTY = item_a4_0.QTY AND __tmp_delta_del_item_a4.ITEM = item_a4_0.ITEM AND __tmp_delta_del_item_a4.ORIGINAL_ID = item_a4_0.ORIGINAL_ID ) ) AS p_1_a4_1 
WHERE p_2_a4_0.COL3 = p_1_a4_1.COL3 ) AS p_0_a0_0  ) AS bot_a0_0  ) AS __dummy__ )
        THEN 
...
FROM (SELECT  
FROM (SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1._ID = gorda_a7_0._ID AND gorda_a7_0.H  <>  gorda_a7_1.H  UNION ALL SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1._ID = gorda_a7_0._ID AND gorda_a7_0.ITEM  <>  gorda_a7_1.ITEM  UNION ALL SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1._ID = gorda_a7_0._ID AND gorda_a7_0.ORIGINAL_ID  <>  gorda_a7_1.ORIGINAL_ID  UNION ALL SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1._ID = gorda_a7_0._ID AND gorda_a7_0.QTY  <>  gorda_a7_1.QTY  UNION ALL SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1._ID = gorda_a7_0._ID AND gorda_a7_0.UOM  <>  gorda_a7_1.UOM  UNION ALL SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1._ID = gorda_a7_0._ID AND gorda_a7_0.W  <>  gorda_a7_1.W  UNION ALL SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1.ORIGINAL_ID = gorda_a7_0.ORIGINAL_ID AND gorda_a7_0.ITEM  <>  gorda_a7_1.ITEM  UNION ALL SELECT  
FROM public.gorda AS gorda_a7_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1.ORIGINAL_ID = gorda_a7_0.ORIGINAL_ID AND gorda_a7_0.QTY  <>  gorda_a7_1.QTY ) AS p_0_a0_0  ) AS bot_a0_0  ) AS __dummy__ )
        THEN 
...
FROM __tmp_delta_del_item_ar AS __tmp_delta_del_item_ar_a4_0, public.gorda AS gorda_a7_1 
WHERE gorda_a7_1.ITEM = __tmp_delta_del_item_ar_a4_0.ITEM AND gorda_a7_1.UOM = __tmp_delta_del_item_ar_a4_0.UOM AND gorda_a7_1.ORIGINAL_ID = __tmp_delta_del_item_ar_a4_0.ORIGINAL_ID AND gorda_a7_1.QTY = __tmp_delta_del_item_ar_a4_0.QTY ) AS p_0_a7_0  ) AS delta_del_gorda_a7_0  ) AS delta_del_gorda_extra_alias) AS tbl;
...
FROM (SELECT p_0_a7_0.COL0 AS COL0, p_0_a7_0.COL1 AS COL1, p_0_a7_0.COL2 AS COL2, p_0_a7_0.COL3 AS COL3, p_0_a7_0.COL4 AS COL4, p_0_a7_0.COL5 AS COL5, p_0_a7_0.COL6 AS COL6 
FROM (SELECT '' AS COL0, __tmp_delta_ins_item_ar_a4_0.ORIGINAL_ID AS COL1, __tmp_delta_ins_item_ar_a4_0.ITEM AS COL2, __tmp_delta_ins_item_ar_a4_0.QTY AS COL3, 0 AS COL4, 0 AS COL5, __tmp_delta_ins_item_ar_a4_0.UOM AS COL6 
FROM __tmp_delta_ins_item_ar AS __tmp_delta_ins_item_ar_a4_0 
WHERE NOT EXISTS ( SELECT * 
FROM public.gorda AS gorda_a7 
WHERE gorda_a7.QTY = __tmp_delta_ins_item_ar_a4_0.QTY AND gorda_a7.ITEM = __tmp_delta_ins_item_ar_a4_0.ITEM AND gorda_a7.ORIGINAL_ID = __tmp_delta_ins_item_ar_a4_0.ORIGINAL_ID ) ) AS p_0_a7_0  ) AS delta_ins_gorda_a7_0  ) AS delta_ins_gorda_extra_alias) AS tbl; 
...
AS $$
  ...
  BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
      ...
      END IF;
      DELETE FROM __tmp_delta_del_item WHERE ROW(ORIGINAL_ID,ITEM,QTY,UOM) = NEW;
      INSERT INTO __tmp_delta_ins_item SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
      IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update on view: view does not accept null value';
      END IF;
      DELETE FROM __tmp_delta_ins_item WHERE ROW(ORIGINAL_ID,ITEM,QTY,UOM) = OLD;
